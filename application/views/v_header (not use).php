...
<div class="container-fluid">
  <nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="205" style="border-radius: 0px;">
    <div class="navbar-header">
		...
		<a class="navbar-brand" href="#">NJr Shop</a>
	</div>
	...
	<div class="collapse navbar-collapse js-navbar-collapse">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" style="width: 400px;" role="menu">
             <li>
           <div class="row">
              <div class="col-md-12" style="width: 380px; margin-left: 25px; margin-top: 10px; ">
              <br>
              <form class="form" role="form" method="post" action="<?php echo base_url(); ?>login/cekLogin" accept-charset="UTF-8" id="loginform">
                    ...
                    <div class="help-block text-right" style="margin-top: -30px;"><a href="#">Forget the password ?</a></div>
                    </div>
                    <div class="form-group">
                ...
                <div class="social-buttons">
                  <a href="#" class="btn btn-fb btn-block"> Login via <i class="fa fa-facebook"></i> Facebook</a>
                  <a href="#" class="btn btn-tw btn-block"> Login via <i class="fa fa-twitter"></i> Twitter</a>
                </div>
              </div>
           </div>
           <br>
