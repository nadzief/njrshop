<div class="col-md-offset-10">
    <div id="content">
        <div class="row">
            <div style="margin-left: 20px; width: 1080px;">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a>
                    </li>
                    <li>Produk</li>
                    <li class="active"><a href="<?php echo site_url().'web/katalog_alat_musik';?>"> Alat Musik </a>
                    </li>
                </ol>
            </div>
        ...
        <?php 
            $no=1; 
            foreach ($produk_alatmusik as $produk) { 
                $id=$produk->id_produk; 
    ...
    <!-- <div class="1" align="center"> <?php echo $pagination; ?> </div> -->
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li>Produk</li>
            <li class="active"><a href="<?php echo site_url().'web/katalog_hp';?>"> HP </a>
            </li>
        </ol>
    </div>
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li>Produk</li>
            <li class="active"> <a href="<?php echo site_url().'web/katalog_laptop'; ?>"> Laptop </a>
            </li>
        </ol>
    </div>
    ...
    <?php $no=1 ; foreach ($produk_jersey as $produkjersey) { $id=$produkjersey->id_produk; $nama_produk = $produkjersey->nama_produk; $stok = $produkjersey->stok; $harga = $produkjersey->harga; ?>

    <div class="col-sm-3 col-md-3">
        <div class="thumbnail" class="img-responsive">
            <img src="<?php echo base_url() ?>/produk/olahraga/jersey/<?php echo $produkjersey->gambar; ?>" style="max-width: 100%; max-height: 100%; height: 100px;">
