<!-- BEGIN CONTENT -->
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_user"> <span class="fa fa-plus"> </span> Add User </button>
        <button class="btn btn-default" onclick="reload_table_user()"><i class="fa fa-refresh"></i> Reload</button>
        <br>
        <br>
...
function edit_user(id_anggota)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/user_edit/')?>/" + id_anggota,
        type: "GET",
        dataType: "JSON",
...
function delete_user(id_anggota)
{
    if(confirm('Are you sure delete this data?'))
    {
        $.ajax({
            url : "<?php echo site_url('admin/user_delete')?>/"+id_anggota,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="id_anggota" class="form-control" type="text" style="height: 30px;" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_lengkap" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="jenis_kelamin" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kota" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="no_rek" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="foto" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                ...
                <form action="#" id="forms" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3">ID :</label>
                            <div class="col-md-9">
                                <input name="id_anggota" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
