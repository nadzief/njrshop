        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Data Wilayah Kecamatan</a>
                    </li>
                </ul>
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_wilayah_kecamatan"> <span class="fa fa-plus"> </span> Add Wilayah Kecamatan </button>
        <button class="btn btn-default" onclick="reload_table_wilayah_kecamatan()"><i class="fa fa-refresh"></i> Reload</button>
        <br>
        <br>
        <div class="box-body table-responsive">
            <table id="table_wilayah_kecamatan" class="table table-bordered table-striped">
...
$(document).ready(function() {
    table14 = $('#table_wilayah_kecamatan').dataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [], 
        "ajax": {
            "url": "<?php echo site_url('admin/wilayah_kecamatan_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
function add_wilayah_kecamatan()
{
    save_method = 'add';
    $('#form')[0].reset(); 
    ...
    $('.modal-title').text('Add Wilayah Kecamatan');
}

function edit_wilayah_kecamatan(id)
{
    save_method = 'update';
    $('#form')[0].reset(); 
    $('.form-group').removeClass('has-error'); 
    ...
    $.ajax({
        url : "<?php echo site_url('admin/wilayah_kecamatan_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('#modal_form_wilayah_kecamatan').modal('show');
            $('.modal-title').text('Edit Data Wilayah Kecamatan'); 
        },
...
function reload_table_wilayah_kecamatan()
{
    table14.api().ajax.reload(null,false);  
}
...
function save_add()
{
    ...
    url = "<?php echo site_url('admin/wilayah_kecamatan_add')?>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_add_wilayah_kecamatan').modal('hide');
                reload_table_wilayah_kecamatan();
            }
            $('#btnSave').text('save'); 
...
function save_edit()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('admin/wilayah_kecamatan_update')?>";
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_form_wilayah_kecamatan').modal('hide');
                reload_table_wilayah_kecamatan();
            }
            $('#btnSave').text('save'); 
            $('#btnSave').attr('disabled',false);  
...
function delete_wilayah_kecamatan(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        $.ajax({
            url : "<?php echo site_url('admin/wilayah_kecamatan_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_wilayah_kecamatan" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Form Data Wilayah Kecamatan</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Kabupaten ID :</label>
                            <div class="col-md-9">
                                <input name="kabupaten_id" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="modal_add_wilayah_kecamatan" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
