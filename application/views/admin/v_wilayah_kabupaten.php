        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Data Wilayah Kabupaten</a>
                    </li>
                </ul>
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_wilayah_kabupaten"> <span class="fa fa-plus"> </span> Add Wilayah Kabupaten </button>
        <button class="btn btn-default" onclick="reload_table_wilayah_kabupaten()"><i class="fa fa-refresh"></i> Reload</button>
        <br>
        <br>
        <div class="box-body table-responsive">
            <table id="table_wilayah_kabupaten" class="table table-bordered table-striped">
...
$(document).ready(function() {
    table13 = $('#table_wilayah_kabupaten').dataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [], 
        "ajax": {
            "url": "<?php echo site_url('admin/wilayah_kabupaten_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
function add_wilayah_kabupaten()
{
    save_method = 'add';
    $('#form')[0].reset(); 
    ...
    $('.modal-title').text('Add Wilayah Kabupaten');
}

function edit_wilayah_kabupaten(id)
{
    save_method = 'update';
    $('#form')[0].reset(); 
    $('.form-group').removeClass('has-error'); 
    ...
    $.ajax({
        url : "<?php echo site_url('admin/wilayah_kabupaten_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('#modal_form_wilayah_kabupaten').modal('show');
            $('.modal-title').text('Edit Data Wilayah Kabupaten'); 
        },
...
function reload_table_wilayah_kabupaten()
{
    table13.api().ajax.reload(null,false);  
}
...
function save_add()
{
    ...
    url = "<?php echo site_url('admin/wilayah_kabupaten_add')?>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_add_wilayah_kabupaten').modal('hide');
                reload_table_wilayah_kabupaten();
            }
            $('#btnSave').text('save'); 
...
function save_edit()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('admin/wilayah_kabupaten_update')?>";
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_form_wilayah_kabupaten').modal('hide');
                reload_table_wilayah_kabupaten();
            }
            $('#btnSave').text('save'); 
            $('#btnSave').attr('disabled',false);  
...
function delete_wilayah_kabupaten(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        $.ajax({
            url : "<?php echo site_url('admin/wilayah_kabupaten_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_wilayah_kabupaten" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Form Data Wilayah Kabupaten</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Provinsi ID :</label>
                            <div class="col-md-9">
                                <input name="provinsi_id" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="modal_add_wilayah_kabupaten" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
