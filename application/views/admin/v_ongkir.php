<!-- BEGIN CONTENT -->
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_ongkir"> <span class="fa fa-plus"> </span> Add Ongkir </button>
        <button class="btn btn-default" onclick="reload_table_ongkir()"><i class="fa fa-refresh"></i> Reload</button>
        <br>
        <br>
        <div class="box-body table-responsive">
            <table id="table_ongkir" class="table table-bordered table-striped">
...
$(document).ready(function() {
    table11 = $('#table_ongkir').dataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [], 
        "ajax": {
            "url": "<?php echo site_url('admin/ongkir_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
function edit_ongkir(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/ongkir_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('#modal_form_ongkir').modal('show');
            $('.modal-title').text('Edit Data Ongkir'); 
        },
...
function save_add()
{
    ...
    url = "<?php echo site_url('admin/ongkir_add')?>";
...
function save_edit()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('admin/ongkir_update')?>";
    }
...
function delete_ongkir(id)
{
    ...
    {
        $.ajax({
            url : "<?php echo site_url('admin/ongkir_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_ongkir" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Form Data Ongkir</h3>
            </div>
...
<div class="modal fade" id="modal_add_ongkir" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
