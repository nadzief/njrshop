<!-- BEGIN CONTENT -->
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Data Laporan Pembelian</a>
                    </li>
                </ul>
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_laporan_pembelian"> 
            <span class="fa fa-plus"> </span> Add Laporan Pembelian 
        </button>
        <button class="btn btn-default" onclick="reload_table_laporan_pembelian()">
            <i class="fa fa-refresh"></i> Reload
        </button>

        <a href="<?php echo site_url().'admin/cetak_pdf_lap_pembelian'; ?>"> 
            <button type="button" class="btn btn-default"> 
                <i class="fa fa-file-pdf-o"></i> Cetak PDF 
            </button> 
        </a>

        <a href="<?php echo site_url().'admin/cetak_excel_lap_pembelian'; ?>"> 
            <button type="button" class="btn btn-default"> 
        ...
        <div class="box-body table-responsive">
            <table id="table_laporan_pembelian" class="table table-bordered table-striped">
...
$(document).ready(function() {
    table16 = $('#table_laporan_pembelian').dataTable({ 
        "processing": true, 
        "serverSide": true, 
        "order": [], 
        "ajax": {
            "url": "<?php echo site_url('admin/laporan_pembelian_list')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
...
function add_laporan_pembelian()
{
    save_method = 'add';
    $('#form')[0].reset(); 
    ...
    $('.modal-title').text('Add Laporan Pembelian');
}

function edit_laporan_pembelian(id)
{
    save_method = 'update';
    $('#form')[0].reset(); 
    $('.form-group').removeClass('has-error'); 
    ...
    $.ajax({
        url : "<?php echo site_url('admin/laporan_pembelian_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="jasa_pengiriman"]').val(data.jasa_pengiriman);
            ...
            $('#modal_form_laporan_pembelian').modal('show');
            $('.modal-title').text('Edit Data Laporan Pembelian'); 
        },
...
function reload_table_laporan_pembelian()
{
    table16.api().ajax.reload(null,false);  
}
...
function save_add()
{
    ...
    url = "<?php echo site_url('admin/laporan_pembelian_add')?>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_add_laporan_pembelian').modal('hide');
                reload_table_laporan_pembelian();
            }
            $('#btnSave').text('save'); 
...
function save_edit()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('admin/laporan_pembelian_update')?>";
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data.status) 
            {
                $('#modal_form_laporan_pembelian').modal('hide');
                reload_table_laporan_pembelian();
            }
            $('#btnSave').text('save'); 
            $('#btnSave').attr('disabled',false);  
...
function delete_laporan_pembelian(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        $.ajax({
            url : "<?php echo site_url('admin/laporan_pembelian_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
<div class="modal fade" id="modal_form_laporan_pembelian" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h3 class="modal-title">Form Data Laporan Pembelian</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kabupaten" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Jasa Pengiriman :</label>
                            <div class="col-md-9">
                                <input name="jasa_pengiriman" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="desa" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="provinsi" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kode_pos" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kecamatan" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="tgl" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="jam" class="form-control" type="text" style="height: 30px;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="modal_add_laporan_pembelian" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
